...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total xChr0n0 balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized xChr0n0 balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in xChr0n0/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in xChr0n0/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"xChr0n0address\"\n"
            "\nReturn information about the given xChr0n0 address.\n"
            "\nArguments:\n"
            "1. \"xChr0n0address\"     (string, required) The xChr0n0 address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"xChr0n0address\", (string) The xChr0n0 address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: xChr0n0 address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are xChr0n0 addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) xChr0n0 address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"xChr0n0address\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"xChr0n0address\"  (string, required) The xChr0n0 address to use for the signature.\n"
