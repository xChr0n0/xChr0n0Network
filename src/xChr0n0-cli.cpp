...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("xChr0n0 Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  xChr0n0-cli [options] <command> [params]  " + _("Send command to xChr0n0 Core") + "\n" +
                        "  xChr0n0-cli [options] help                " + _("List commands") + "\n" +
                        "  xChr0n0-cli [options] help <command>      " + _("Get help for a command") + "\n";
