...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::x00)
    {
    }
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("x00")
    updateDisplayUnit();
}
...
void OverviewPage::updateObfuscationProgress()
{
    ...
    QString strAnonymizexChr0n0Amount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizexChr0n0Amount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizexChr0n0Amount = strAnonymizexChr0n0Amount.remove(strAnonymizexChr0n0Amount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizexChr0n0Amount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    ...
    if (nMaxToAnonymize > nAnonymizexChr0n0Amount * COIN) nMaxToAnonymize = nAnonymizexChr0n0Amount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizexChr0n0Amount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                              .arg(strAnonymizexChr0n0Amount));
        strAnonymizexChr0n0Amount = strAnonymizexChr0n0Amount.remove(strAnonymizexChr0n0Amount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizexChr0n0Amount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    } else {
