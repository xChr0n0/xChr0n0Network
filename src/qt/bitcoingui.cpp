                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("xChr0n0 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a xChr0n0 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xChr0n0: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About xChr0n0 Core"), this);
    aboutAction->setStatusTip(tr("Show information about xChr0n0 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for xChr0n0"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your xChr0n0 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified xChr0n0 addresses"));
    ...
    openAction->setStatusTip(tr("Open a xChr0n0: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the xChr0n0 Core help message to get a list with possible xChr0n0 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("xChr0n0 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xChr0n0 network", "", count));
}
...
{
    QString strTitle = tr("xChr0n0 Core"); // default title
