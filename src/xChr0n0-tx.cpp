...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("xChr0n0 Core xChr0n0-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xChr0n0-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xChr0n0 transaction") + "\n" +
                               "  xChr0n0-tx [options] -create [commands]   " + _("Create hex-encoded xChr0n0 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xChr0n0 transaction
