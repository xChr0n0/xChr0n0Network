...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "xChr0n0 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"xChr0n0", "masternode", &masternode, true, true, false},
        {"xChr0n0", "listmasternodes", &listmasternodes, true, true, false},
        {"xChr0n0", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xChr0n0", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xChr0n0", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xChr0n0", "masternodedebug", &masternodedebug, true, true, false},
        {"xChr0n0", "startmasternode", &startmasternode, true, true, false},
        {"xChr0n0", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xChr0n0", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xChr0n0", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xChr0n0", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xChr0n0", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xChr0n0", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xChr0n0", "mnbudget", &mnbudget, true, true, false},
        {"xChr0n0", "preparebudget", &preparebudget, true, true, false},
        {"xChr0n0", "submitbudget", &submitbudget, true, true, false},
        {"xChr0n0", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xChr0n0", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xChr0n0", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xChr0n0", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xChr0n0", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xChr0n0", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xChr0n0", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xChr0n0", "checkbudgets", &checkbudgets, true, true, false},
        {"xChr0n0", "mnsync", &mnsync, true, true, false},
        {"xChr0n0", "spork", &spork, true, true, false},
        {"xChr0n0", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xChr0n0", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xChr0n0d, or the -server option to xChr0n0-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xChr0n0-cli " + methodname + " " + args + "\n";
}
