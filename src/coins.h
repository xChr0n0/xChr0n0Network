...
/** 
    ...
    ****Note - for xChr0n0 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of xChr0n0 coming in to a transaction
