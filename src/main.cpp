...
#if defined(NDEBUG)
#error "xChr0n0 cannot be compiled without assertions."
#endif
...
int64_t nSubsidy = 0;
    ...
    } else if (nHeight <= 129600 && nHeight >= 1) {
        nSubsidy = 75 * COIN;
    } else if (nHeight <= 259200 && nHeight > 129600) {
        nSubsidy = 57 * COIN;
    } else if (nHeight <= 388800 && nHeight > 259200) {
        nSubsidy = 43 * COIN;
    } else if (nHeight <= 518400 && nHeight > 388800) {
        nSubsidy = 33 * COIN;
    } else if (nHeight <= 648000 && nHeight > 518400) {
        nSubsidy = 25 * COIN;
    } else if (nHeight <= 777600 && nHeight > 648000) {
        nSubsidy = 19 * COIN;
