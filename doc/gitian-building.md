...
*Setup instructions for a gitian build of xChr0n0 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the xChr0n0
...
- [Building xChr0n0](#building-xChr0n0)
...
Clone the git repositories for xChr0n0 and gitian and then checkout the xChr0n0 version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the xChr0n0 repository
...
To build xChr0n0 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the xChr0n0 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/xChr0n0/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/xChr0n0-crypto/xChr0n0
...
For example:
```bash
URL=https://github.com/crowning-/xChr0n0.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit xChr0n0=${COMMIT} --url xChr0n0=${URL} ../xChr0n0/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit xChr0n0=${COMMIT} --url xChr0n0=${URL} ../xChr0n0/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit xChr0n0=${COMMIT} --url xChr0n0=${URL} ../xChr0n0/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/xChr0n0-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/xChr0n0-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/xChr0n0-build.assert
```
...
[xChr0n0/gitian.sigs](https://github.com/xChr0n0-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
