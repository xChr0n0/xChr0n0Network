...
In order to support loading of multiple wallets in xChr0n0-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xChr0n0.cpp.
...
Changes to xChr0n0.cpp
----------------------
xChr0n0.cpp is the entry point into xChr0n0-qt, and as such, will require some minor modifications to provide hooks for
