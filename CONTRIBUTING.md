Contributing to xChr0n0 Core
============================

The xChr0n0 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the xChr0n0 Core project, and is not to be
confused with overall xChr0n0 Network Protocol consensus changes.

Whether a pull request is merged into xChr0n0 Core rests with the project merge
...
Patches that change xChr0n0 consensus rules are considerably more involved than
...
Where a patch set proposes to change the xChr0n0 consensus, it must have been
...
The project leader is the release manager for each xChr0n0 Core release.
